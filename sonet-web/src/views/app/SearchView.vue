<template>
  <div class="p-8 max-w-3xl mx-auto anim-fade-up">
    <h1 class="text-2xl font-semibold mb-6" style="font-family: var(--font-heading)">Поиск</h1>
    ...
    <div v-if="results.length" class="space-y-2">
      <div
        ...
        class="p-4 bg-bg-surface/60 border border-transparent rounded-xl cursor-pointer hover:bg-bg-surface hover:border-border hover:shadow-[0_2px_12px_rgba(45,32,24,0.05)] transition-all duration-200"
      >
